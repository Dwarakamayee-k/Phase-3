...
public class ShoesService {
	...
	@Autowired
	 ...
	 public List<ShoesDataModel> getMensShoeData() {
		 ...
		 List<ShoesDataModel> mensData= (List)shoesDao.findByCategeory(1);
 ...
 public List<ShoesDataModel> getWomensShoeData() {
		 ...
		 List<ShoesDataModel> womensData= (List)shoesDao.findByCategeory(2);
 ...
 public List<ShoesDataModel> getKidsShoeData() {
	 ...
	 List<ShoesDataModel> kidsData= (List)shoesDao.findByCategeory(3);
...
public List<ShoesDataModel> getShoeDatabyCategeory(int categeoryid) {
	 ...
	 List<ShoesDataModel> shoesDatabyCategeory= (List)shoesDao.findByCategeory(categeoryid);
        
       return shoesDatabyCategeory;
    }
 
 public ShoesDataModel  getshoesDataByIdService(int selectedShoeId)
{
	 
	  ShoesDataModel  selectedShoesData=  shoesDao.getshoesDataById(selectedShoeId);
